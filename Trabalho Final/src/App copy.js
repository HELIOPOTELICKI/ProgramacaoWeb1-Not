...
import * as _ from './components/script';
        ...
        <div className="EditaAdiciona">
          <div id="NovoEmpregado" className="NovoEmpregado">  
            ...
            <div id="BTNNovoEmpregado" className="BTNNovoEmpregado">
              <button type="submit" value="Submit" className="FormBTNS" onClick= { _.saveInputs }>Salvar</button>
              <button type="reset" value="Reset" className="FormBTNS" onClick= { _.clearInputs }>Cancelar</button>
            </div>
          </div>
          <div id="EscondeEditor" className="EscondeEditor">
            <div id="NovoEmpregado" className="NovoEmpregado">  
              ...
              <div id="BTNNovoEmpregado" className="BTNNovoEmpregado">
                ...
                <button type="reset" value="Reset" className="FormBTNS" onClick= { _.clearInputsEdit }>Cancelar</button>
              </div>
            </div>
          </div>
        </div>
        <div id="AlertaExcluir" className="AlertaExcluir">
          <form className="AlertaExcluir">
            ...
            <div id="BTNExcluir" className="BTNExcluir">
              ...
              <button type="reset" value="Reset" className="FormBTNS" onClick= { _.confirmacaoExcluirDSP }>Cancelar</button>
            </div>
          </form>
        </div>
      </div>
